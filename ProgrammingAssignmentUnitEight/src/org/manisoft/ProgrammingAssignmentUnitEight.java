...
public class ProgrammingAssignmentUnitEight {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Average salary of all employees is: $%2.2f\n",
                avgSalary);
        System.out.println();
        ...
        empAges(ageStatistics);

        // Display salaries per age
        salaryPerAgeRange(ageStatistics, employees);

        DescriptiveStatistics salStatistics = new DescriptiveStatistics(
                employees, (emp) -> emp.getAnnualSalary());

        // Finds the company's departments
        ...
        emplByDept.stream()
                .forEach((listEmp) -> {
                    DescriptiveStatistics stat = new DescriptiveStatistics(
                            listEmp, (emp) -> emp.getAnnualSalary());
                    deptSalariesStatistics(listEmp.get(0).getDepartment(),
                            listEmp, stat);
                });
    }

    private static void empSalariesStatistics(DescriptiveStatistics stat) {
    ...
    private static void deptSalariesStatistics(String dept,
        ...
        empSalariesStatistics(stat);
        System.out.println();
    }

    private static void empAges(DescriptiveStatistics stat) {
    ...
    private static void salaryPerAgeRange(DescriptiveStatistics ageStat,
    ...
    private static void companyDepartments(List<String> departments) {
